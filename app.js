...
import datosFiscales from './src/routes/datos.fiscales.routes.js';
import longitudRoutes from './src/routes/empresas/longitud.routes.js';
...
const App = {
	main: async () => {
		...
		app.use('/api/v1/empresas/longitud', longitudRoutes);
		app.use('/', (req, res) => {
			res.send(`¡ERP-API!`);
		});
