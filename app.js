...
import ownTaxRoutes from './src/routes/impuestos.propios.routes.js';
...
const App = {
	main: async () => {
		...
		app.use('/api/v1/impuestos/propios', ownTaxRoutes);
		app.use('/api/v1/impuestos/compuestos', compoundTaxRoutes);
