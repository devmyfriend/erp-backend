...
/**
 * @swagger
 * /api/v1/catalogo/producto/servicio/buscar/{code}:
 *   get:
 *     tags:
 *       - Productos Servicios
 ...
 */
router.get(
	'/producto/servicio/buscar/:code',
	methods.findProductServicesByCode,
);

/**
 * @swagger
 * /api/v1/catalogo/producto/servicio/buscar/{descripcion}:
 *   get:
 *     tags:
 *       - Productos Servicios
 ...
 */
router.get(
	'/producto/servicio/buscar/:descripcion',
	methods.findProductServicesByDescription,
);

/**
 * @swagger
 * /ap1/v1/catalogo/producto/servicio/palabra/{palabra}:
 *   get:
 *     tags:
 *       - Productos Servicios
 ...
 */
router.get(
	'/producto/servicio/palabra/:palabra',
	methods.findProductServicesByMatchWord,
);

/**
 * @swagger
 * /api/v1/catalogo/producto/servicio:
 *   post:
 *     tags:
 *       - Productos Servicios
 ...
 *       500:
 *         description: Error al crear el producto/servicio
 */
router.post(
	'/producto/servicio',
 ...
 *         description: Error al crear el producto/servicio
 */
router.patch('/producto/servicio',
 ...
 *       500:
 *         description: Error al borrar el producto/servicio
 */
router.delete('/producto/servicio',
