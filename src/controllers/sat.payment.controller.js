import { FormaDePago, MetodoDePago } from "../models/index.js";
...
const createPaymentMethods = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ error: 'Error al crear el metodo de pago' });
    }
};
...
const updatePaymentMethods = async (req, res) => {
    ...
    try {
        ...
        if (!payment) {
            return res.status(404).json({ error: 'No se encontro el metodo de pago' });
        }
        ...
        return res.status(500).json({ error: 'Error al actualizar el metodo de pago' });
    }
};
...
const deletePaymentMethods = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({ message: 'Se ha eliminado el metodo de pago' });
    } catch (error) {
        console.log('Error al eliminar el metodo de pago', error);
        return res.status(500).json({ error: 'Error al eliminar el metodo de pago' });
    }
};
...
const createPaymentType = async (req, res) => {
    ...
    try { 
        ...
        return res.status(500).json({ error: 'Error al crear el tipo de pago' });
    }
}
...
const updatedPaymentType = async (req, res) => {
    ...
    try{
        ...
        if (!payment) {
            return res.status(404).json({ error: 'No se encontro el tipo de pago' });
        }
        ...
        return res.status(500).json({ error: 'Error al actualizar el tipo de pago' });
    }
}
...
const deletePaymentType = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({ message: 'Se ha eliminado el tipo de pago' });
    } catch (error) {
        console.log('Error al eliminar el tipo de pago', error);
        return res.status(500).json({ error: 'Error al eliminar el tipo de pago' });
    }
};
...
const searchPaymentTypeByDescription = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ error: 'Error al buscar el tipo de pago' });
    }
}
